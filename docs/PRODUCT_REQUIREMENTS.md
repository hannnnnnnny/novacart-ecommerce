...
- Product detail with gallery, title, description, effective price, compare-at price, discount badge, size selector, color selector, quantity selector, stock status, material, care, shipping/return summary, add to cart, buy now, related products, collection link, and review placeholder.
...
- Admin audit trail.
- More granular inventory adjustments and reserved stock.
